...
# importar los datos del repo en github
...
# crear tablas con cada uno de los archivos .dsv y .csv
...
# crear algunas subtablas para luego agregar los datos
...
# crear tabla de totales por agrupacion politica
...
# crear tabla de totales por agrupacion politica - sólo nivel nacional
...
# crear tabla de totales por lista
